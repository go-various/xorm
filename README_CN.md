...
- 删除了对 `github.com/go-various/core` 的依赖。大部分代码迁移到了 `github.com/go-various/xorm/core`, `github.com/go-various/xorm/names`, `github.com/go-various/xorm/schemas` 等等几个包中.
...
* Schema支持（仅Postgres）
* 支持缓存
* 通过 [github.com/go-various/reverse](https://github.com/go-various/reverse) 支持根据数据库自动生成 xorm 结构体
* 支持记录版本（即乐观锁）
...
* [操作指南](http://github.com/go-various/docs)

* [Godoc代码文档](http://pkg.go.dev/github.com/go-various/xorm)
